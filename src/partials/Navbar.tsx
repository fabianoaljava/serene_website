...
import sereneLogo from '@/images/serene_logo.svg';
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <a
          href="/"
          className="font-heading text-2xl font-medium tracking-wider"
        >
          <img
            src={sereneLogo.src}
            alt="Serene Logo"
        ...
        <nav className="flex flex-col gap-3 px-6 py-4">
          {navLinks.map((link) => (
            <a
              ...
              className="border-b border-outline/10 py-2 font-body text-sm uppercase tracking-[0.08em] text-onSurface/80 transition-colors last:border-none hover:text-gold"
            >
              {link.label}
            </a>
          ))}
